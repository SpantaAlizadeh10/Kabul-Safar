...
const content: Record<Lang, LocalizedContent> = {
  fa: {
    ...
    hero: {
      ...
      description:
        "کابل سفر با مشاوره رایگان و پیگیری سریع، دریافت ویزای ایران و ترکیه را برای شما ساده می‌کند. پشتیبانی به زبان‌های دری، پشتو و انگلیسی همیشه در کنار شماست.",
